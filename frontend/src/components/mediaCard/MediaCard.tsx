...
export default function MediaCard() {
  ...
  return (
    <div>
      <div className="relative mx-auto my-10 w-full max-w-md overflow-hidden rounded-3xl bg-gradient-to-r from-[#1D2235] to-[#121318] p-8">
        <Rays />
        <Beams />
...
const Beams = () => {
  return (
    <svg
      ...
      className="pointer-events-none absolute top-0 left-1/2 w-full -translate-x-1/2"
    >
