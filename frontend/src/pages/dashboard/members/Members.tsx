...
const Members: React.FC = () => {
  ...
  const [invitedRole, setInvitedRole] = useState("Manager");
  ...
  const [addMemberForm, setAddMemberForm] = useState({
    ...
    zipCode: "",
    country: "",
    role: "Manager", // Added role to form
  });
  ...
  const handleRoleChange = (role: string) => {
    setAddMemberForm((prev) => ({ ...prev, role }));
  };

  const handleSaveMember = () => {
    console.log("Member added:", addMemberForm);
  ...
  return (
    <div className="dark:bg-background relative mx-auto mt-10 w-full max-w-7xl rounded-lg border bg-white shadow-md dark:text-white">
      ...
      {showAddMemberModal && (
        <div
          onClick={closeModal}
          className="bg-opacity-40 absolute inset-0 z-50 flex items-center justify-center px-4 py-60"
        >
          <div className="dark:bg-background relative w-full max-w-lg rounded-2xl border bg-white p-6 shadow-lg dark:text-white">
            <button
            ...
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-500">
                Fill in the details to add a member manually.
              </p>
            </div>
              ...
              {[
                ...
                <div key={name}>
                  ...
                  <input
                    ...
                    name={name}
                    value={(addMemberForm as any)[name]}
                    ...
                    <PopoverContent className="w-full">
                      {["Admin", "Manager", "Client"].map((role) => (
                        <div
                          ...
                          className="hover:bg-accent my-2 cursor-pointer px-2 py-1"
                        >
